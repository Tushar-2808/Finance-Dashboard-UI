...
export const computeMonthlyBreakdown = transactions => {
  ...
  for (let i = 5; i >= 0; i--) {
    ...
    for (const t of transactions) {
      ...
      if (isWithinInterval(tDate, {
        ...
        if (t.kind === 'income') income += t.amount;else expenses += t.amount;
      }
    }
    months.push({
      month: label,
...
export const computeCategoryTotals = transactions => {
