...
const IncomeExpenseBarChart = ({ monthlyBreakdown }: IncomeExpenseBarChartProps) => {
  return (
    <Card className="animate-slide-up border-0 shadow-sm p-6">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={monthlyBreakdown} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
            ...
            <Tooltip
              ...
              labelStyle={{ fontWeight: 800, color: '#111827', marginBottom: '8px', fontSize: '11px', textTransform: 'uppercase' }}
            />
            <Legend
              iconType="circle"
              iconSize={8}
              wrapperStyle={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', paddingTop: 20 }}
              formatter={(value: string) => <span className="text-gray-500">{value === 'income' ? 'Income' : 'Expenses'}</span>}
            />
