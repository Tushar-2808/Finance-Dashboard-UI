...
const InsightsPage = () => {
  ...
  return <div className="space-y-6">
      {/* Insight tiles */}
      <InsightTile topCategoryByAmount={topCategoryByAmount} topCategoryByCount={topCategoryByCount} avgMonthlySpend={avgMonthlySpend} savingsRate={savingsRate} />

      {/* Income vs Expense chart */}
      <IncomeExpenseBarChart monthlyBreakdown={monthlyBreakdown.filter(m => m.income > 0 || m.expenses > 0)} />
