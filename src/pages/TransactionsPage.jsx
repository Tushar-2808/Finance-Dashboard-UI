...
const TransactionsPage = () => {
  ...
  return <div className="space-y-0">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        {activeRole === 'admin' && <Button size="sm" onClick={handleAdd}>
            <Plus size={16} />
            Add Transaction
          </Button>}
      </div>
      ...
      {activeRole === 'admin' && <TransactionFormModal open={modalOpen} onClose={handleCloseModal} editingTransaction={editingTx} />}
    </div>;
};
